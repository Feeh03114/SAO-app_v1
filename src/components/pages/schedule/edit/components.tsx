...
function Field({ size, label, data }:FieldProps) {
    return (
        <div className={`w-1/2 mt-4 ${size}`}>
            ...
            <div className="h-10 mx-2 px-4 py-3 font-medium leading-tight truncate dark:text-white placeholder-gray-500 dark:placeholder-white shadow-sm border rounded-lg border-gray-300 dark:border-gray-500 dark:bg-slate-700 focus:border-teal-400 focus:outline-none focus:ring-teal-400">
                {data}
            </div>
        </div>
    )
