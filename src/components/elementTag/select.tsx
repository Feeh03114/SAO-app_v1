            ...
            render={({ field }) => (
                <>
                    ...
                    <select
                        ...
                        className={twMerge("aria-checked:mt-5 w-full h-10 px-4 py-0 md:py-2 text-sm shadow-sm dark:text-white border rounded-lg border-gray-300 dark:border-gray-500 truncate placeholder-gray-500 dark:bg-slate-700 focus:border-teal-400 focus:outline-none focus:ring-teal-400", 
                        className)}
                        aria-checked={!label}
