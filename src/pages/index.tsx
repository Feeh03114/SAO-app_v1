...
export default function Home():JSX.Element {
  ...
  return (
    <>
      ...
      <div className={twMerge(poppins.className,"w-full mt-12 py-12 pb-10 px-36 relative bg-gradient-96 from-teal-500 to-teal-600 flex flex-col")}>
        <div className='flex items-center justify-between'>
          ...
          <div className='flex flex-col text-white'>
            <span className='font-semibold text-xl'>Informações</span>
            <span className={twMerge(inter.className,"opacity-80 text-base leading-normal whitespace-nowrap")}>Pagina Inicial</span>
            <span className={twMerge(inter.className,"opacity-80 text-base leading-normal whitespace-nowrap")}>Sobre</span>
            <span className={twMerge(inter.className,"opacity-80 text-base leading-normal whitespace-nowrap")}>Contato</span>
          </div>
          <div className='flex flex-col text-white'>
        ...
        <span className={twMerge(inter.className,"mx-auto text-white opacity-80 text-base leading-normal whitespace-nowrap")}>© SAO all rights 2023</span>
      </div>
    </>
  )
}
