        ...
        <>
            {
                password?
                    <div className="relative w-full">
                        ...
                        <div className="absolute inset-y-0 right-0 pr-3 flex items-center text-sm leading-5 cursor-pointer">
                            ...
                            <svg className={`h-4 md:h-6 text-gray-700 ${!showPassword&&'invisible hidden'} ${showPassword&&'block'}`} fill="none" xmlns="http://www.w3.org/2000/svg" onClick={()=>setShowPassword(!showPassword)}
                            viewBox="0 0 640 512">
                                <path fill="currentColor"
                ...
                <>
                    ...
                    <input className={`w-full h-7 md:h-10 px-4 py-2 text-sm shadow-sm border rounded-lg border-gray-300 dark:border-gray-500 truncate`}
                        {...rest}
                        ref={ref}
                    />
                </>
